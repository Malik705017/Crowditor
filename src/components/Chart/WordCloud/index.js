...
const options = {
  ...
  fontWeight: "normal",
  padding: 1,
  rotations: 1, //restrict to vertical & horizontal
  rotationAngles: [0, 90],
  scale: "log",
  spiral: "archimedean",
...
export default function WordCloud() {
  const [graph, setGraph] = useState(
    <ReactWordcloud options={options} words={all} />
  );
  ...
  return (
    <div>
      <button onClick={changeAll}>全部類別</button>
      <button onClick={changePublish}>出版</button>
      <button onClick={changeLocal}>地方創生</button>
      <button onClick={changeComic}>插畫漫畫</button>
      <button onClick={changePhoto}>攝影</button>
      <button onClick={changeEducation}>教育</button>
      <button onClick={changeFashion}>時尚</button>
      <button onClick={changeSociety}>社會</button>
      <button onClick={changeTech}>科技</button>
      <button onClick={changeSpace}>空間</button>
      <button onClick={changeArt}>藝術</button>
      <button onClick={changePerform}>表演</button>
      <button onClick={changeDesign}>設計</button>
      <button onClick={changeGame}>遊戲</button>
      <button onClick={changeMovie}>電影動畫</button>
      <button onClick={changeMusic}>音樂</button>
      <button onClick={changeFood}>飲食</button>
      <button onClick={changeLocal}>地方創生</button>
      <button onClick={changeComic}>插畫漫畫</button>
      <button onClick={changePhoto}>攝影</button>
      <button onClick={changeEducation}>教育</button>
